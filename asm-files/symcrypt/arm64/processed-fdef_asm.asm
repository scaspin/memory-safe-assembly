...
#define X_16 x16
#define W_16 w16
    LEAF_ENTRY ARM64EC_NAME_MANGLE(SymCryptFdefRawSquareAsm)
...
LABEL(SymCryptFdefRawSquareAsmThirdPass)
    ...
    ret
    LEAF_END ARM64EC_NAME_MANGLE(SymCryptFdefRawSquareAsm)
#undef X_0
#undef W_0
#undef X_1
#undef W_1
...
#define X_17 x17
#define W_17 w17
    LEAF_ENTRY ARM64EC_NAME_MANGLE(SymCryptFdefMontgomeryReduceAsm)
...
LABEL(SymCryptFdefMontgomeryReduceMaskedCopyAsmLoop)
    ...
    ret
    LEAF_END ARM64EC_NAME_MANGLE(SymCryptFdefMontgomeryReduceAsm)
#undef X_0
#undef W_0
#undef X_1
#undef W_1
