...
// #[bums_macros::check_mem_safe_from_build( context.as_mut_ptr(), input.as_ptr(), input.len() / 128, [input.len() >= 128, input.len()%128==0])]
...
// TODO: engine4: ParseIntError { kind: InvalidDigit }
