...
#[bums_macros::check_mem_safe("crypto-playground/generated-asm/linux-aarch64/crypto/fipsmodule/sha256-armv8.S", context.as_mut_ptr(), input.as_ptr(), input.len() / SHA256_CBLOCK)]
